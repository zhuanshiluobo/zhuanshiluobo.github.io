export const posts = [
  ...
  },
  {
    ...
    title: "游城拓荒策划案：影响力系统",
    date: "2026-09-06",
    summary: "按功能、界面与场景三个维度整理《游城拓荒》影响力系统，列出显示规则、点击反馈等设计结构，为后续实现提供策划框架。",
    content: "\n      <p>本策划案围绕《游城拓荒》的影响力系统，按功能、界面与场景整理设计结构，并列出显示规则、点击反馈逻辑等后续实现要点。</p>\n      <div class=\"download-card\">\n        <strong>游城拓荒策划案-影响力系统.xlsx</strong>\n        <span>原始 Excel 文档 · 约 10.3 KB</span>\n        <a\n          class=\"download-link\"\n          href=\"/downloads/you-cheng-tuo-huang-influence-system.xlsx\"\n          download=\"游城拓荒策划案-影响力系统.xlsx\"\n        >下载完整文档</a>\n      </div>\n    ",
    tags: ["游城拓荒", "游戏开发"]
  }
]
